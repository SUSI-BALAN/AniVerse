...
export function AnimeDetailsPage() {
  ...
  const listMenu = useRef<HTMLDivElement>(null);
  const listControl = useRef<HTMLDivElement>(null);
  useEffect(() => { if (listOpen) listMenu.current?.querySelector<HTMLElement>('[role="menuitem"]')?.focus(); }, [listOpen]);
